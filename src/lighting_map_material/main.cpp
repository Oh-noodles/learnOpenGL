...
int main() {
  ...
  Shader objectShader("src/lighting_map_material/shader.vs", "src/lighting_map_material/lighting_object_shader.fs");
  Shader lightSourceShader("src/lighting_map_material/shader.vs", "src/lighting_map_material/light_source_shader.fs");
